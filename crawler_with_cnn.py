# -*- coding: utf-8 -*-
"""Crawler with CNN.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1h8woAJ6lejBtj3ph6i8rY_hLZgm1xll2

# Topic-Spesific Crawler


---
ECE537 Information Retrieval Project
...
directory = r'/content/drive/MyDrive/Crawler/Spider1/'
###
...
# define model
CNNmodel = define_model(length, vocab_size)
# fit model
CNNmodel.fit([trainX,trainX,trainX], array(trainLabels), epochs=10, batch_size=16)
# save the model
CNNmodel.save('/content/drive/MyDrive/MovieDataset/txt_sentoken/model.h5')
####################################################################3
from pickle import load
from numpy import array
from keras.preprocessing.text import Tokenizer
...
# load the model
CNNmodel = load_model('/content/drive/MyDrive/MovieDataset/txt_sentoken/model.h5')

# evaluate model on training dataset
loss, acc = CNNmodel.evaluate([trainX,trainX,trainX], array(trainLabels), verbose=0)
print('Train Accuracy: %f' % (acc*100))

# evaluate model on test dataset dataset
loss, acc = CNNmodel.evaluate([testX,testX,testX],array(testLabels), verbose=0)
    ...
    for filename in os.listdir(directory):  #iterate with the files in the directory
            if filename.endswith(".html") : # select only the html files
                ...
                if len(post_text)>5:
                  ...
                  #prediction = CNNmodel.predict([np.array(temp),np.array(temp),np.array(temp)])
                  print("I am here prediction")
                  time.sleep(0.2)
